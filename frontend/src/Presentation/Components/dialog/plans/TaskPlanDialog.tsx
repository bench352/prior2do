...
export default function TaskPlanDialog(props: editPlanProps) {
    ...
    return (
        ...
        >
                ...
                <Grid container spacing={3} columns={{xs: 6, md: 12}}>
                    <Grid item xs={6} md={5}>
                        <Stack
                            ...
                            spacing={1}
                        >
                            <h3>{t("dialogs.common.description")}</h3>
                    ...
                    <Grid item xs={6} md={7}>
                        <Stack spacing={1}>
                            <h3>{t("dialogs.planRelated.taskPlan.planned.label")}</h3>
                            {workSessions
                                .sort(
                                    (a, b) =>
                            ...
                            >
                                {t("dialogs.planRelated.taskPlan.addSession.button")}
                            </Button>
                        </Stack>
                    </Grid>
                </Grid>
            ...
            <DialogActions>
                <Button onClick={props.handleHideDialog}>{t("dialogs.common.button.okay")}</Button>
            </DialogActions>
