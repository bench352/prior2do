...
import EditTaskDialog from "../../Components/dialog/tasks/EditTaskDialog";
        ...
        <Container disableGutters={isMobileScreenSize}>
            ...
            >
                ...
                <FormControl sx={{m: 1, minWidth: 120}} size="small">
                    <InputLabel id="filter-by-tag">{t("dropbox.filterBy.label")}</InputLabel>
                    <Select
                        id="filter-by-tag"
                        value={filterTagId}
                    ...
                    >
                        <MenuItem value="">
                            <em>{t("dropbox.filterBy.noFilter")}</em>
                        </MenuItem>
                        {props.tags.map((tag) => (
